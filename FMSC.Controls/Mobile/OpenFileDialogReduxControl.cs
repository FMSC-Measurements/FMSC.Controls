...
{
    public class OpenFileDialogReduxControl : Form
    {
        ...
        /// </summary>
        public OpenFileDialogReduxControl()
        {
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            if (this.DialogResult == DialogResult.OK)
            {
                if (this.SelectedFile == null
                    && !string.IsNullOrEmpty(this.txtFileName.Text))
                {
                    if (Path.HasExtension(this.txtFileName.Text))
                    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ddVisitedLocations.Size = new System.Drawing.Size(168, 23);
            ...
            this.txtFileName.Location = new System.Drawing.Point(0, 20);
            ...
            this.Name = "OpenFileDialogReduxControl";
            this.Text = "Open File";
